...
#define AR9462_BBC_TXIFR_COEFFJ \
	...
	if (AR_SREV_9330_11(ah)) {
		...
		INIT_INI_ARRAY(&ah->iniMac[ATH_INI_CORE],
			       ar9462_2p1_mac_core,
			       ARRAY_SIZE(ar9462_2p1_mac_core),
			       ARRAY_SIZE(ar9462_2p1_mac_core[0]));
		INIT_INI_ARRAY(&ah->iniMac[ATH_INI_POST],
			       ar9462_2p1_mac_postamble,
			       ARRAY_SIZE(ar9462_2p1_mac_postamble),
			       ARRAY_SIZE(ar9462_2p1_mac_postamble[0]));
		INIT_INI_ARRAY(&ah->iniBB[ATH_INI_CORE],
			       ar9462_2p1_baseband_core,
			       ARRAY_SIZE(ar9462_2p1_baseband_core),
			       ARRAY_SIZE(ar9462_2p1_baseband_core[0]));
		INIT_INI_ARRAY(&ah->iniBB[ATH_INI_POST],
			       ar9462_2p1_baseband_postamble,
			       ARRAY_SIZE(ar9462_2p1_baseband_postamble),
			       ARRAY_SIZE(ar9462_2p1_baseband_postamble[0]));
		INIT_INI_ARRAY(&ah->iniRadio[ATH_INI_CORE],
			       ar9462_2p1_radio_core,
			       ARRAY_SIZE(ar9462_2p1_radio_core),
			       ARRAY_SIZE(ar9462_2p1_radio_core[0]));
		INIT_INI_ARRAY(&ah->iniRadio[ATH_INI_POST],
			       ar9462_2p1_radio_postamble,
			       ARRAY_SIZE(ar9462_2p1_radio_postamble),
			       ARRAY_SIZE(ar9462_2p1_radio_postamble[0]));
		INIT_INI_ARRAY(&ah->ini_radio_post_sys2ant,
			       ar9462_2p1_radio_postamble_sys2ant,
			       ARRAY_SIZE(ar9462_2p1_radio_postamble_sys2ant),
			       ARRAY_SIZE(
					ar9462_2p1_radio_postamble_sys2ant[0]));
		INIT_INI_ARRAY(&ah->iniSOC[ATH_INI_PRE],
			       ar9462_2p1_soc_preamble,
			       ARRAY_SIZE(ar9462_2p1_soc_preamble),
			       ARRAY_SIZE(ar9462_2p1_soc_preamble[0]));
		INIT_INI_ARRAY(&ah->iniSOC[ATH_INI_POST],
			       ar9462_2p1_soc_postamble,
			       ARRAY_SIZE(ar9462_2p1_soc_postamble),
			       ARRAY_SIZE(ar9462_2p1_soc_postamble[0]));
		INIT_INI_ARRAY(&ah->iniModesRxGain,
			       ar9462_2p1_common_rx_gain,
			       ARRAY_SIZE(ar9462_2p1_common_rx_gain),
			       ARRAY_SIZE(ar9462_2p1_common_rx_gain[0]));
		INIT_INI_ARRAY(&ah->iniModesFastClock,
			       ar9462_2p1_modes_fast_clock,
			       ARRAY_SIZE(ar9462_2p1_modes_fast_clock),
			       ARRAY_SIZE(ar9462_2p1_modes_fast_clock[0]));
		INIT_INI_ARRAY(&ah->iniCckfirJapan2484,
			       ar9462_2p1_baseband_core_txfir_coeff_japan_2484,
			       ARRAY_SIZE(
			ar9462_2p1_baseband_core_txfir_coeff_japan_2484),
			       ARRAY_SIZE(
			ar9462_2p1_baseband_core_txfir_coeff_japan_2484[0]));
...
static void ar9003_tx_gain_table_mode0(struct ath_hw *ah)
{
	if (AR_SREV_9330_12(ah))
		...
		INIT_INI_ARRAY(&ah->iniModesTxGain,
			...
			ARRAY_SIZE(ar9462_2p1_modes_low_ob_db_tx_gain),
			ARRAY_SIZE(ar9462_2p1_modes_low_ob_db_tx_gain[0]));
	else if (AR_SREV_9462_20(ah))
		INIT_INI_ARRAY(&ah->iniModesTxGain,
...
static void ar9003_tx_gain_table_mode1(struct ath_hw *ah)
{
	if (AR_SREV_9330_12(ah))
		...
		INIT_INI_ARRAY(&ah->iniModesTxGain,
			...
			ARRAY_SIZE(ar9462_2p1_modes_high_ob_db_tx_gain),
			ARRAY_SIZE(ar9462_2p1_modes_high_ob_db_tx_gain[0]));
	else if (AR_SREV_9462_20(ah))
		INIT_INI_ARRAY(&ah->iniModesTxGain,
...
static void ar9003_tx_gain_table_mode4(struct ath_hw *ah)
{
	if (AR_SREV_9462_21(ah))
		INIT_INI_ARRAY(&ah->iniModesTxGain,
			...
			ARRAY_SIZE(ar9462_2p1_modes_mix_ob_db_tx_gain),
			ARRAY_SIZE(ar9462_2p1_modes_mix_ob_db_tx_gain[0]));
}
...
static void ar9003_rx_gain_table_mode1(struct ath_hw *ah)
{
	if (AR_SREV_9330_12(ah))
		...
		INIT_INI_ARRAY(&ah->iniModesRxGain,
			...
			ARRAY_SIZE(ar9462_2p1_common_wo_xlna_rx_gain),
			ARRAY_SIZE(ar9462_2p1_common_wo_xlna_rx_gain[0]));
	else if (AR_SREV_9462_20(ah))
		INIT_INI_ARRAY(&ah->iniModesRxGain,
...
static void ar9003_rx_gain_table_mode2(struct ath_hw *ah)
{
	if (AR_SREV_9462_21(ah))
		INIT_INI_ARRAY(&ah->iniModesRxGain,
			       ...
			       ARRAY_SIZE(ar9462_2p1_common_mixed_rx_gain),
			       ARRAY_SIZE(ar9462_2p1_common_mixed_rx_gain[0]));
...
static void ar9003_rx_gain_table_mode3(struct ath_hw *ah)
{
	if (AR_SREV_9462_21(ah))
		INIT_INI_ARRAY(&ah->iniModesRxGain,
			...
			ar9462_2p1_common_5g_xlna_only_rx_gain),
			       ARRAY_SIZE(
			ar9462_2p1_common_5g_xlna_only_rx_gain[0]));
}
