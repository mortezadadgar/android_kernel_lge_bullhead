...
#define HWCTX_REGINFO(offset, count, type) \
	{offset, count, HWCTX_REGINFO_##type, offset}
#define HWCTX_REGINFO_RST(offset, count, type, rst) \
	{offset, count, HWCTX_REGINFO_##type, rst}
