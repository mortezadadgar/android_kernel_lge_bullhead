...
static struct tegra_shared_clk shared_clks[] = {
	SHARED_CLK("cap.c2bus", "c2bus", SHARED_CEILING, 0, 0, NULL, tegra_clk_cap_c2bus),
	SHARED_CLK("cap.throttle.c2bus", "c2bus", SHARED_CEILING, 0, 0, NULL, tegra_clk_cap_throttle_c2bus),
	SHARED_CLK("floor.c2bus", "c2bus", 0, 0, 0, NULL, tegra_clk_floor_c2bus),
	SHARED_CLK("override.c2bus", "c2bus", SHARED_OVERRIDE, 0, 0, NULL, tegra_clk_override_c2bus),
	SHARED_CLK("edp.c2bus", "c2bus", SHARED_CEILING, 0, 0, NULL, tegra_clk_edp_c2bus),
	SHARED_CLK("battery.c2bus", "c2bus", SHARED_CEILING, 0, 0, NULL, tegra_clk_battery_c2bus),
	SHARED_CLK("cap.profile.c2bus", "c2bus", SHARED_CEILING, 0, 0, NULL, tegra_clk_cap_profile_c2bus),
	...
	SHARED_CLK("usbd.sclk", "sbus", 0, 0, 0, NULL, tegra_clk_usbd_sclk),
	SHARED_CLK("usb1.sclk", "sbus", 0, 0, 0, NULL, tegra_clk_usb1_sclk),
	SHARED_CLK("usb2.sclk", "sbus", 0, 0, 0, NULL, tegra_clk_usb2_sclk),
	SHARED_CLK("usb3.sclk", "sbus", 0, 0, 0, NULL, tegra_clk_usb3_sclk),
	SHARED_CLK("wake.sclk", "sbus", 0, 0, 0, NULL, tegra_clk_wake_sclk),
	SHARED_CLK("sbc1.sclk", "sbus", 0, 0, 0, NULL, tegra_clk_sbc1_sclk),
	SHARED_CLK("sbc2.sclk", "sbus", 0, 0, 0, NULL, tegra_clk_sbc2_sclk),
	SHARED_CLK("sbc3.sclk", "sbus", 0, 0, 0, NULL, tegra_clk_sbc3_sclk),
	SHARED_CLK("sbc4.sclk", "sbus", 0, 0, 0, NULL, tegra_clk_sbc4_sclk),
	...
	SHARED_CLK("msenc.emc", "emc_master", SHARED_BW, 0, 0, NULL, tegra_clk_msenc_emc),
	...
	SHARED_CLK("camera.emc", "emc_master", SHARED_BW, 0, 0, NULL, tegra_clk_camera_emc),
	SHARED_CLK("iso.emc", "emc_master", SHARED_BW, 0, 0, NULL, tegra_clk_iso_emc),
	SHARED_CLK("cap.emc", "emc_master", SHARED_CEILING, 0, 0, NULL, tegra_clk_cap_emc),
	SHARED_CLK("cap.throttle.emc", "emc_master", SHARED_CEILING, 0, 0, NULL, tegra_clk_cap_throttle_emc),
	SHARED_CLK("floor.emc", "emc_master", 0, 0, 0, NULL, tegra_clk_floor_emc),
	SHARED_CLK("override.emc", "emc_master", SHARED_OVERRIDE, 0, 0, NULL, tegra_clk_override_emc),
	SHARED_CLK("edp.emc", "emc_master", SHARED_CEILING, 0, 0, NULL, tegra_clk_edp_emc),
	SHARED_CLK("battery.emc", "emc_master", SHARED_CEILING, 0, 0, NULL, tegra_clk_battery_emc),
	...
	SHARED_CLK("ahub.emc", "emc_master", SHARED_BW, 0, 0, NULL, tegra_clk_ahub_emc),
};
