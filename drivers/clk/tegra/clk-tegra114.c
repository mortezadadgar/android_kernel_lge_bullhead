...
static struct tegra_clk tegra114_clks[tegra_clk_max] __initdata = {
	[tegra_clk_cop] = { .dt_id = TEGRA114_CLK_COP, .present = true },
	...
	[tegra_clk_i2c1_8] = { .dt_id = TEGRA114_CLK_I2C1, .present = true },
	...
	[tegra_clk_i2c5_8] = { .dt_id = TEGRA114_CLK_I2C5, .present = true },
	...
	[tegra_clk_i2c2_8] = { .dt_id = TEGRA114_CLK_I2C2, .present = true },
	...
	[tegra_clk_i2c3_8] = { .dt_id = TEGRA114_CLK_I2C3, .present = true },
	...
	[tegra_clk_i2cslow_8] = { .dt_id = TEGRA114_CLK_I2CSLOW, .present = true },
	...
	[tegra_clk_i2c4_8] = { .dt_id = TEGRA114_CLK_I2C4, .present = true },
