...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cclk_lp",	0, 0, 1, KHZ,   396000, 528000, 660000, 804000, 912000, 1044000, 1140000, 1140000),
	CORE_DVFS("cclk_lp",	0, 1, 1, KHZ,   420000, 564000, 696000, 828000, 960000, 1092000, 1140000, 1140000),
	CORE_DVFS("cclk_lp",	1, -1, 1, KHZ,  420000, 564000, 696000, 828000, 960000, 1092000, 1188000, 1188000),
